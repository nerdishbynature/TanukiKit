...
public extension TanukiKit {
     ...
     */
    public func projects(session: RequestKitURLSession = NSURLSession.sharedSession(), page: String = "1", perPage: String = "100", completion: (response: Response<[Project]>) -> Void) {
